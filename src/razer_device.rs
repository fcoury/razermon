use crate::razer_report::{RazerReport, RazerReportError};
...
impl RazerDevice {
    pub fn new(kind: RazerDeviceKind, hid_device: HidDevice) -> Self {
    ...
    pub fn get_firmware_version(&self) -> Result<RazerFirmwareVersion, RazerReportError> {
        ...
        thread::yield_now();
        let response_payload = report.receive_packet(&self.hid_device)?;
